...
let resta = 10 - 5; //5 --> Resta
let multiplicacion = 10 * 5;//50 --> Multiplicación
let division = 25 / 5; //5 --> División
...
let number = 10;
number++; //11 incrementa en 1 la variable
number--; //9 decrementa en 1 la variable
...
let dado = Math.floor(Math.random()*6) + 1; //Valor entre 1 y 6
